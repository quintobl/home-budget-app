...
public class Credit
{
    ...
    // Many credits can belong to one account, but each credit must be associated with a single account.
    ...
    // Many credits can belong to one category, but each credit must be associated with a single category.
    ...
    // Many credits can share the same description, but each credit must be associated with a single description.
